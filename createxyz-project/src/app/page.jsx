      ...
      {isPlaying ? (
        <div className="w-full h-full flex items-center justify-center">
          <img
            ...
            className={`object-cover rounded-full transition-all duration-200 active:scale-90 hover:scale-105 ${
              powerUpActive
                ? "border-4 border-[#FFFF00] shadow-[0_0_40px_#FFFF00]"
                : "border-4 border-[#0066FF] shadow-[0_0_40px_#0066FF]"
            }`}
          />
        </div>
      ) : (
